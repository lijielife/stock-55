...
<!--            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-files-o fa-fw"></i>Test<span class="fa arrow"></span></a>
                        <ul class="nav nav-third-level">
                            <li>
            ...
            <li>
                <a href="#"><i class="fa fa-files-o fa-fw"></i>History<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">

                    <li>
                        <a href="#"><i class="fa fa-files-o fa-fw"></i>Investor<span class="fa arrow"></span></a>
                        <ul class="nav nav-third-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-files-o fa-fw"></i>RuayHoon<span class="fa arrow"></span></a>
                        <ul class="nav nav-third-level">
            ...
            <li class="active">
                <a href="#"><i class="fa fa-files-o fa-fw"></i>Charts<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
