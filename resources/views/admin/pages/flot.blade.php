...
<script src="{{asset('/assets/bower_components/flot/excanvas.min.js')}}"></script>
...
<script src="{{asset('/assets/bower_components/flot/jquery.flot.time.js')}}"></script>
<script src="{{asset('/assets/bower_components/flot.tooltip/js/jquery.flot.tooltip.min.js')}}"></script>
