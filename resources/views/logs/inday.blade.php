                    ...
                    <div class="form-group col-md-2 col-md-offset-3">
                            <div class="input-group date">
                                ...
                                <input id="date" name="date"
                                   ...
                                   value="@if($date){{$date}}@else{{$currDate}}@endif" 
...
<!--                data-row-attributes="rowAttributes" -->
        <table id="tbl" data-toggle="table" 
                ...
                data-url="{{url('logs/inday/getData')}}"
...
<!--                 <th data-field="DATE" data-halign="center" data-align="center" 
                 ...
                 <th data-field="SYMBOL" data-halign="center" data-align="left" 
                     data-sortable="true" data-cell-style="cellStyle"
                     >ชื่อ</th>
<!--                <th data-field="PRICE_IN_DAY" data-halign="center" data-align="right" 
                 ...
                 <th data-field="PRICE" data-halign="center" data-align="right" 
                     data-sortable="true" data-formatter="numFormatter2">ราคา</th>
                 <th data-field="VAT" data-halign="center" data-align="right" 
                     data-sortable="true" data-formatter="numFormatter2"
                     data-footer-formatter="sumFormatter">ภาษี</th>
                 <th data-field="NET_AMOUNT" data-halign="center" data-align="right" 
                     data-sortable="true" data-footer-formatter="sumFormatter"
                     data-formatter="numFormatter2" >ราคาสุทธิ</th>
...
<!--                 <th data-field="TOTAL" data-halign="center" data-align="right" 
                 ...
                 <th data-field="BROKER_NAME" data-halign="center" data-align="right" 
                     data-sortable="true" data-visible="true">โบรค</th>
...
<script src="{{asset('/assets/js/logs-inday.js')}}" type="text/javascript"></script>
