...
-- 03/09/58
ALTER TABLE `super_stock_db`.`log_map` 
ADD UNIQUE INDEX `LOG_MAP_UNIQUE` (`MAP_SRC` ASC, `MAP_DESC` ASC)  COMMENT '';


-- 11/09/58
ALTER TABLE `data_log` ADD `DUE_DATE` DATE NOT NULL AFTER `DATE`;
UPDATE `data_log` SET `DUE_DATE` = `DATE`

-- 12/09/58
CREATE TABLE `super_stock_db`.`no_data` (
  `ID` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `SYMBOL_ORIGIN` VARCHAR(45) NULL COMMENT '',
  `SYMBOL` VARCHAR(45) NULL COMMENT '',
